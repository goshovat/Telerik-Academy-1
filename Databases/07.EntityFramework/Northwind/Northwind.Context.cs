...
namespace Northwind
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> usp_GetTotalIncomeForSupplier(string supplierName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_GetTotalIncomeForSupplier", supplierNameParameter, startDateParameter, endDateParameter);
        }
    }
}
